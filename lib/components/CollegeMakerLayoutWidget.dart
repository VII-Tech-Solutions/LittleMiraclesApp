...
class CollegeMakerLayoutWidget extends StatefulWidget {
  ...
  @override
  _CollegeMakerLayoutWidgetState createState() =>
      _CollegeMakerLayoutWidgetState();
}
    ...
    return ClipRRect(
      ...
      child: Container(
        ...
        padding: EdgeInsets.all(
            widget.borderWidth == 0 ? 0 : itemSpacing.toDouble()),
        child: LayoutBuilder(
          builder: (ctx, constraint) {
            return widget.columnCountList![0] != 0
                ? AnimatedSwitcher(
                    ...
                    child: Row(
                      children: List.generate(widget.columnCountList!.length,
                          (index) {
                        return Column(
                          children: List.generate(
                              widget.columnCountList![index].toInt(), (i) {
                            return Container(
                              ...
                              child: ClipRRect(
                                ...
                                child: PhotoView(
                                  imageProvider: Image.file(
                                          appStore.collegeMakerImageList[
                                              _imageItemIndex++])
                                      .image,
                ...
                : AnimatedSwitcher(
                    ...
                    child: Column(
                      children: List.generate(
                          widget.columnCountList!.length - 1, (index) {
                        return Row(
                          children: List.generate(
                              widget.columnCountList![index + 1].toInt(), (i) {
                            return Container(
                              padding: EdgeInsets.all(widget.spacing!),
                              decoration: BoxDecoration(
                                border: widget.borderWidth == 0
