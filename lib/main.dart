...
// this method is called when a push notification is recieved and the app is in background state
      ...
      providers: [
        ...
        ChangeNotifierProxyProvider<Auth, AppData>(
          update: (context, auth, previousAppData) => AppData(
            ...
            previousAppData == null ? [] : previousAppData.packagePhotographers,
