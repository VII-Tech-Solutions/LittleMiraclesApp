...
//   void initState() {
//     List selectedList = [];
//     selectedList = context.read<Bookings>().selectedCakesMulti;
//     setState(() {
//       colorIds = selectedList;
//     });
...
//                         int indexFound = colorIds.indexWhere((item) =>
//                             item['category_id'] ==
//                                 appDataProvider
//                                     .cakeCategories[widget.index].id &&
//                             item['color_id'] ==
//                                 appDataProvider.cakes[index].id);

//                         if (indexFound != -1) {
//                           setState(() {
//                             colorIds.removeAt(indexFound);
//                           });
//                         } else {
//                           setState(() {
...
//                               colorIds.clear();
//                               colorIds.add({
//                                 'category_id': appDataProvider
//                                     .cakeCategories[widget.index].id,
//                                 "color_id": appDataProvider.cakes[index].id
//                               });
//                             } else if (sparkleAllowSelection > 1 &&
//                                 sparkleAllowSelection == colorIds.length) {
//                               colorIds.removeAt(0);
//                               colorIds.add({
//                                 'category_id': appDataProvider
//                                     .cakeCategories[widget.index].id,
...
//                         // if (colorIds.contains(currentColor)) {
//                         //   setState(() {
//                         //     colorIds.removeWhere((element) =>
//                         //         element['color_id'] ==
//                         //         appDataProvider.cakes[index].id);
//                         //   });
//                         // } else {
//                         //   // setState(() {
//                         //   //   colorIds.add(appDataProvider.cakes[index].id);
//                         //   // });
//                         //   setState(() {
//                         //     if (sparkleAllowSelection == 1) {
//                         //       colorIds.clear();
...
//                                 appDataProvider
//                                     .cakeCategories[widget.index].id &&
//                             item['color_id'] == appDataProvider.cakes[index].id)
//                         : selectedColor == appDataProvider.cakes[index].id
//                             ? true
//                             : false,
//                     bookingsProvider.package!.id == PackageIds.sparkleId
...
//                         : 1,
//                     id: index,
//                     // allow multiple selection for sparkle ..
//                   );
//                 },
//                 childCount: appDataProvider.cakes.length,
//               ),
...
//                 {
//                   'category_id':
//                       appDataProvider.cakeCategories[widget.index].id,
//                   'color_id': selectedColor
//                 }
//               ];
//             }
