...
//                         bookingsProvider.assignSelectedCakesMultiple(colorId2);
//                       } else {
//                         setState(() {
//                           colorId = colorId2;
//                         });
...
//               ),
//             ),
//             // for sparkle ... dont show no cake custom cake
...
//             if (bookingsProvider.package!.id == PackageIds.sparkleId) {
//               if (bookingsProvider.selectedCakesMulti.length !=
//                   bookingsProvider.childCount) {
//                 ShowOkDialog(context,
//                     'Please select ${bookingsProvider.childCount} cakes to proceed');
//               } else {
//                 print(bookingsProvider.selectedCakesMulti);
//                 Navigator.pop(context);
//               }
//             } else {
//               if (widget.subPackage != null) {
